...
export default function Chatbot(props: ChatbotProps) {
  ...
  useEffect(() => {
    const initialMessage = {
      id: 1,
      message: `안녕하세요! 저는 Aura 전문 챗봇입니다.

Neo4j Aura에 대해 궁금하신 점이 있다면 무엇이든 도와드릴 수 있습니다.
                            ...
                            <div className='flex gap-1'>
                              {chat.typeMessage != 'First' ? (
                                <>
                                  ...
                                  <IconButton isDisabled={loading} isClean ariaLabel='메시지 복사' onClick={() => copy(chat.message)}>
                                    <ClipboardDocumentIconOutline className='w-4 h-4 inline-block' />
                                  </IconButton>
                                  <IconButton isDisabled={loading} isClean ariaLabel='답변 다시 생성'>
                                    <ArrowPathIconOutline
